(function () {
  ...
  const PROFILES = {
    gi1: {
      ...
      media: {
        ...
        pageBackground: "/assets/gi1-background-v1.jpg",
        pageBackgroundPosition: "calc(50% - 400px) top",
        profileBackground: "/assets/gi1-background-v1.jpg",
    ...
    "4hn": {
      ...
      media: {
        ...
        profileBackground: "/assets/4hn-background-v1.jpg",
    ...
    aang: {
      ...
      theme: "#b9c7d6",
      media: {
        avatar: "/assets/aang-profile-v2.jpg",
        pageBackground: "/assets/aang-background-v1.jpg",
        pageBackgroundPosition: "center 22%",
        profileBackground: "/assets/aang-background-v1.jpg",
        highlightPoster: "/assets/aang-highlight-poster-v1.jpg",
  ...
  function applyProfile(profile) {
    ...
    setAttr(".avatar-ring img", "src", media.avatar || profile.avatar || "/recruitment-webhook-logo.png");
