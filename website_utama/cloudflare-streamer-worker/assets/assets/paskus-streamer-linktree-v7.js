(function () {
  ...
  const PROFILES = {
    gi1: {
      ...
      media: {
        ...
        highlightPoster: "/assets/gi1-highlight-poster-v2.jpg",
        highlightWebm: "/assets/gi1-highlight-v2.webm",
        highlightMp4: "/assets/gi1-highlight-v2.mp4",
        avatarPhoto: true,
        preferMp4: true,
      },
    },
  ...
  function profileMedia(profile) {
    ...
    return { ...legacyMedia, ...localMedia, ...remoteMedia };
  }
