(function () {
  ...
  const PASKUS_DISCORD_URL = "https://discord.gg/ynRhDN5p7b";
  ...
  const PROFILES = {
    gi1: {
      ...
      media: {
        ...
        highlightPoster: "/assets/gi1-highlight-poster-v1.jpg",
        highlightWebm: "/assets/gi1-highlight-v1.webm",
        highlightMp4: "/assets/gi1-highlight-v1.mp4",
        avatarPhoto: true,
        preferMp4: true,
      },
    },
  ...
  function profileMedia(profile) {
    ...
    if (profile?.avatar) {
      remoteMedia.avatar = profile.avatar;
    }
    if (profile?.background) {
      remoteMedia.pageBackground = profile.background;
    }
    if (profile?.bannerBackground) {
      remoteMedia.pageBackground = profile.bannerBackground;
    }
    if (profile?.profileBackground) {
      remoteMedia.profileBackground = profile.profileBackground;
    }
    if (highlight.poster && !remoteMedia.highlightPoster) {
      remoteMedia.highlightPoster = highlight.poster;
    }
    if (highlight.video && !remoteMedia.highlightWebm && !remoteMedia.highlightVideo) {
      remoteMedia.highlightWebm = highlight.video;
    }
    if (highlight.fallback && !remoteMedia.highlightMp4 && !remoteMedia.highlightFallback) {
      remoteMedia.highlightMp4 = highlight.fallback;
    }

    return { ...localMedia, ...remoteMedia };
  }
