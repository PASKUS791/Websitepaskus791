const API = "/api/streamer-content.php";
      ...
      const fallback = {
        ...
        hub: {
          ...
          discordSocial: { name: "Discord PASKUS", handle: "PASKUS Gi1 / So-791", status: "Community Hub", href: "https://discord.gg/ynRhDN5p7b" },
          officialSocials: [],
          events: [],
          creators: [],
          contentCards: [],
      ...
      function renderCreators() {
        ...
        state.hub.creators.forEach((creator, index) => {
          ...
          item.append(row1, field("Focus / Bio Card", creator.focus, (v) => { creator.focus = v; syncJson(); }, true), row2, field("Tags", (creator.tags || []).join(", "), (v) => { creator.tags = splitTags(v); syncJson(); }));
          list.appendChild(item);
        });
      }
      ...
      document.querySelectorAll("[data-add]").forEach((button) => {
        button.onclick = () => {
          ...
          if (key === "profiles") {
            state.profiles.push({ slug: "new", callSign: "New", displayName: "New Creator", role: "Streamer PASKUS791", handle: "@new", tagline: "", theme: "#d4af37", avatar: "/recruitment-webhook-logo.png", media: { avatar: "", pageBackground: "", profileBackground: "", pageBackgroundPosition: "center top", highlightPoster: "", highlightWebm: "", highlightMp4: "", avatarPhoto: true, preferMp4: false }, subdomain: "new.so791.com", highlight: { video: "", poster: "" }, links: [] });
          } else if (key === "creators") {
            state.hub.creators.push({ name: "New Creator", role: "Creator", focus: "", schedule: "", tags: [], href: "", avatar: "" });
