(function () {
  ...
  const GLOBAL_COPY = {
    id: {
      ...
      unitSelectLabels: {
        ...
        SIERRA: "SIERRA (Gerak Cepat & Serangan Sigap)",
    ...
    en: {
      ...
      unitRoles: { gatam: "Special Operations Priority", bringas: "Ground / Mechanized Infantry", toruk: "Sky Lord / Air Unit", sierra: "Rapid Action & Swift Strike", pathfinder: "Recon & Infiltration", sentinel: "Defense & Combat Medic", komodo: "Regular Force" },
      komodo: {
    ...
    fil: {
      ...
      unitRoles: { gatam: "Special Operations Priority", bringas: "Ground / Mechanized Infantry", toruk: "Sky Lord / Air Unit", sierra: "Gerak Cepat At Sigap", pathfinder: "Recon & Infiltration", sentinel: "Defense & Combat Medic", komodo: "Regular Force" },
      komodo: {
        eyebrow: "Status: regular force / initial barracks",
        subtitle: "Regular Corps So-791",
    ...
    hi: {
      ...
      unitRoles: { gatam: "Special Operations Priority", bringas: "Ground / Mechanized Infantry", toruk: "Sky Lord / Air Unit", sierra: "Gerak Cepat Dan Sigap", pathfinder: "Recon & Infiltration", sentinel: "Defense & Combat Medic", komodo: "Regular Force" },
      komodo: {
        eyebrow: "Status: regular force / initial barracks",
        subtitle: "Regular Corps So-791",
    ...
    jv: {
      ...
      unitRoles: { gatam: "Prioritas Operasi Khusus", bringas: "Darat / Infanteri Mekanis", toruk: "Sky Lord / Unit Udara", sierra: "Gerak Cepat Dan Sigap", pathfinder: "Recon & Infiltrasi", sentinel: "Pertahanan & Combat Medic", komodo: "Pasukan Reguler" },
      komodo: {
        eyebrow: "Status: pasukan reguler / barak awal",
        subtitle: "Reguler Corps So-791",
  ...
  const UNIT_LOCALIZATION = {
    en: {
      ...
      sierra: { category: "Rapid Action & Swift Strike Unit", hero: "SIERRA is a fast-moving infantry cell built for rapid response, decisive action, and swift execution. It opens operational gaps, breaks hostile rhythm, and resolves high-value objectives without losing command discipline.", doctrineTitle: "Swift Movement With Decisive Execution", doctrine: "SIERRA represents the rapid action identity inside PASKUS Gi1. Its personnel move through fast entry, small-cell coordination, sharp communication, and swift execution that supports the main operation with agility and precision.", cards: [["Rapid Entry", "Move into target areas fast and decisively, read openings instantly, and prepare action space for the main force."], ["Swift Strike", "Strike facilities, rhythm, and hostile concentration through fast and calculated action."], ["Agile Cell", "Move as a small cell with quick communication, mature decisions, and disciplined execution."]], priorities: ["Rapid movement", "Decisive action", "Swift decision-making", "Small-cell coordination"], route: "Interview, rapid response test, small-team coordination test, character review, then pre-service period.", footer: "SIERRA / RAPID ACTION CELL So-791" },
  ...
  GLOBAL_COPY.su = {
    ...
    unitRoles: { gatam: "Prioritas Operasi Khusus", bringas: "Darat / Infanteri Mekanis", toruk: "Sky Lord / Unit Udara", sierra: "Gerak Cepat & Serangan Sigap", pathfinder: "Recon & Infiltrasi", sentinel: "Pertahanan & Combat Medic", komodo: "Pasukan Reguler" },
    komodo: {
  ...
  UNIT_LOCALIZATION.su = {
    ...
    sierra: { category: "Rapid Action & Swift Strike Unit", hero: "SIERRA nyaéta sél infanteri khusus anu bergerak gancang, sigap, jeung terukur pikeun muka celah operasi, ngaganggu ritme lawan, sarta ngarengsekeun sasaran penting tanpa leupas tina disiplin komando.", doctrineTitle: "Gerak Gancang Kalayan Eksekusi Tegas", doctrine: "SIERRA jadi identitas unit gerak gancang jeung sigap PASKUS Gi1. Fokusna aya dina manuver kilat, réspon instan kana situasi lapangan, koordinasi tim leutik, jeung eksekusi gancang anu tetep disiplin.", cards: [["Rapid Entry", "Asup ka area sasaran sacara gancang jeung sigap, maca celah, jeung nyiapkeun ruang aksi keur unit utama."], ["Swift Strike", "Serang fasilitas, ritme, jeung konsentrasi lawan sacara gancang jeung terarah."], ["Agile Cell", "Bergerak salaku sél leutik kalayan komunikasi singket, kaputusan matang, jeung disiplin eksekusi."]], priorities: ["Gerak gancang", "Aksi sigap", "Kaputusan kilat", "Koordinasi sél leutik"], route: "Wawancara, uji réspon gancang, uji koordinasi tim leutik, uji karakter, tuluy masa pra-dinas.", footer: "SIERRA / RAPID ACTION CELL So-791" },
  ...
  function ensureUnifiedNavbar() {
    if (!document.getElementById("paskus-hide-nav-style")) {
      ...
      hideStyle.textContent = `
        ...
        nav:not(.paskus-navbar-unified):not(.paskus-seo-footer__links),
    ...
    // ponytail: in React mode, the navbar is rendered inside #root. We do not prepend a dynamic static one.
    return;
  }
  ...
  function mainNavHtml(active = "") {
    ...
    const links = [
      ...
      { href: "/peraturan", key: "regulation", label: ui.nav.regulation },
    ];
    return `
  ...
  function enhanceCombatCards() {
    ...
    const currentChildren = grid ? Array.from(grid.children) : [];
  ...
  function renderStructuralPage(force = false) {
    return; // Handled natively by React
    if (!isStructuralPath()) {
      return;
    }
  ...
  function ensureSeoFooter() {
    return; // Handled natively by React Footer component
    const root = document.querySelector("#root");
  ...
  function shouldUseLightVideoMode() {
    ...
    return reducedMotion || saveData || slowNetwork || isMobile;
  }
