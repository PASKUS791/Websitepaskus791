...
import { Play, ArrowLeft, AlertCircle, Share2 } from "lucide-react";
...
const LOCAL_PROFILES = {
  gi1: {
    ...
    theme: "#d4af37",
    media: {
      avatar: getImageUrl("paskus.webp"),
      pageBackground: getImageUrl("about.webp"),
      profileBackground: getImageUrl("about.webp"),
      highlightPoster: getImageUrl("paskus-streamer-highlight-poster-v1.jpg"),
      highlightWebm: getVideoUrl("paskus-streamer-highlight-v1.webm"),
      highlightMp4: getVideoUrl("paskus-streamer-highlight-v1.mp4"),
      avatarPhoto: false,
    },
    links: [
    ...
    fetch("/api/streamer-content.php")
      ...
      .then((text) => {
        try {
          ...
          return fetch("/api/streamer-content.json").then((r) => r.json());
        }
      })
      .then((payload) => {
      ...
      <div
        ...
        style={{
          ...
          backgroundImage: `radial-gradient(circle at 50% 0%, ${accentColor}30 0%, transparent 40%),
            ...
            url("${media.pageBackground || getImageUrl("about.webp")}")`,
          ...
          <section className="rounded-3xl border border-white/10 bg-black/70 backdrop-blur-xl shadow-2xl overflow-hidden mb-6">
            ...
            <header className="flex flex-col items-center p-6 text-center border-b border-white/5 relative">
              <div
                ...
                style={{
                  backgroundImage: `radial-gradient(circle at 50% 10%, ${accentColor} px, transparent 80%)`,
                }}
              />
                  ...
                  >
                    {link.type === "tiktok" ? (
                      ...
                      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
                        ...
                        <path d="M9.2 12.1h.02M14.8 12.1h.02" stroke="currentColor" strokeWidth="3" strokeLinecap="round" />
                      </svg>
                    ) : (
                      <svg viewBox="0 0 24 24" fill="none" className="w-5 h-5">
...
export default StreamerProfileFeature;
